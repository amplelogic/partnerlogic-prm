...
export default function EditPartnerManagerPage() {
  ...
  const statusOptions = [
    { 
      ...
      label: 'Active', 
      icon: CheckCircle,
      description: 'Manager is actively managing partners',
    ...
    { 
      ...
      label: 'Pending', 
      icon: Clock,
      description: 'Manager account is being set up',
    ...
    { 
      ...
      label: 'Inactive', 
      icon: XCircle,
      description: 'Manager is no longer active',
  ...
  const loadManager = async () => {
    try {
      ...
      setErrors({ submit: 'Failed to load partner manager' })
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push(`/admin/partner-managers/${params.id}`)

    } catch (error) {
      console.error('Error updating partner manager:', error)
      setErrors({ submit: error.message || 'Failed to update partner manager' })
    } finally {
      setSaving(false)
    }
  }
  ...
  return (
    <div className="py-6">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <Link
            href={`/admin/partner-managers/${params.id}`}
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Edit Partner Manager</h1>
              <p className="text-gray-600 mt-1">Update partner manager information</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              type="submit"
              disabled={saving}
              className="inline-flex items-center px-6 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {saving ? (
                <>
