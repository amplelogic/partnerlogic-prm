    ...
    try {
      ...
      try {
        ...
        const supportResult = await notifySupportUsers({
          ...
          message: `Admin updated ticket #${ticket.id.slice(0, 8)} to ${ticketStatuses.find(s => s.value === newStatus)?.label || newStatus}`,
          type: 'support',
          referenceId: ticket.id,
          referenceType: 'support_ticket'
        })
      ...
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <Link href="/admin/support" className="text-blue-600 hover:text-blue-700">
              Back to Support
            </Link>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                <Link
                  href={`/admin/partners/${ticket.partner?.id}`}
                  className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
                >
