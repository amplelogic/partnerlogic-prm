...
// COMPLETE VERSION WITH FILE ATTACHMENTS PREVIEW
'use client'
...
import { 
  ...
  BookOpen, Edit, FileText, FileVideo, 
  FileImage, FileAudio, File, Download,
  Folder, Star, AlertCircle
} from 'lucide-react'

export default function AdminPreviewPage({ params }) {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-red-50 border border-red-200 rounded-xl p-6">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-lg font-semibold text-red-900">Error Loading Preview</h3>
    ...
    <div className="py-6">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={() => router.push(`/admin/knowledge/${params.id}/edit`)}
        ...
        <div className="mb-4">
          <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800">
            👁️ Preview Mode - This is how partners will see this article
          </span>
        </div>
