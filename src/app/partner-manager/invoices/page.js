...
export default function PartnerManagerInvoicesPage() {
  ...
  const loadInvoices = async () => {
    try {
      ...
      // Get deals for assigned partners that are closed_won
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {searchTerm || partnerFilter !== 'all' || dateFilter !== 'all'
                ...
                : 'Your partners don\'t have any closed won deals yet'}
            </p>
          </div>
        ) : (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center text-sm text-gray-600">
                          ...
                          {deal.partner ? (
                            <Link
                              href={`/partner-manager/partners/${deal.partner.id}`}
        ...
        {filteredDeals.length > 0 && (
          <div className="mt-6 bg-blue-50 rounded-lg p-6 border border-blue-100">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div>
                <p className="text-sm font-medium text-blue-900">Active Partners</p>
                <p className="mt-1 text-2xl font-bold text-blue-600">
          ...
          <>
            ...
            <div className="text-center py-12 bg-gray-50 rounded-lg">
              ...
              <p className="mt-1 text-sm text-gray-500">
                {searchTerm || partnerFilter !== 'all' || dateFilter !== 'all' 
                  ? 'Try adjusting your search or filters' 
                  : 'Completed referral orders from your partners will appear here'}
              </p>
            </div>
          ) : (
            <div className="space-y-4">
